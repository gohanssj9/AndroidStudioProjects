...
public class CustomAdapter3 extends RecyclerView.Adapter<CustomAdapter3.MyViewHolder>{
    ...
    public CustomAdapter3(Context context, ArrayList roomImages, ArrayList roomPricesBefore, ArrayList roomPricesAfter, ArrayList percentageOff){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_item_rooms_horizontal,viewGroup, false);
